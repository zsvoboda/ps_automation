...
from pypureclient.flasharray import FileSystem, Directory, Pod, Policy, PolicyRuleNfsClient, PolicyRuleNfsClientPost, \
    ...
    PolicyMemberPost, PolicymemberpostMembers

from purestorage.rest.rest_util import handle_response_with_items, handle_response_with_value, handle_response, \
    FlashArrayError
...
class FlashArray:
    ...
    def delete_export(self, export_name):
        r = self._client.delete_directory_exports(export_names=[export_name])
        return handle_response(r)
